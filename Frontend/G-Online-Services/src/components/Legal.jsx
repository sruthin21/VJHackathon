...
const Legal = () => {
    const categories = [
        { name: 'Service1', description: 'This is Service 1',navi:'/legal/service1' },
        { name: 'Service2 ', description: 'This is Service 1',navi:'/legal/service2' },
        { name: 'Service3', description: 'This is Service 1',navi:'/legal/service3' }
      ];
  return (
