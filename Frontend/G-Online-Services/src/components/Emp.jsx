...
const Emp = () => {
    const categories = [
        { name: 'Service1', description: 'This is Service 1',navi:'/emp/service1' },
        { name: 'Service2 ', description: 'This is Service 1',navi:'/emp/service2' },
        { name: 'Service3', description: 'This is Service 1',navi:'/emp/service3' }
      ];
  return (
